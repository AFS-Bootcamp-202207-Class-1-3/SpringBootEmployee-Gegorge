...
//        OOCL_EMPLOYEES.add(new Employee(1, "George1", 18, "male", 180, 100));
//        OOCL_EMPLOYEES.add(new Employee(2, "George2", 18, "male", 180, 100));
//        OOCL_EMPLOYEES.add(new Employee(3, "George3", 18, "male", 180, 100));
//        IQAX_EMPLOYEES.add(new Employee(4, "George4", 18, "female", 180, 100));
//        IQAX_EMPLOYEES.add(new Employee(5, "George5", 18, "female", 180, 100));
